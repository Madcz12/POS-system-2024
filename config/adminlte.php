        ...
        'Sweetalert2' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => 'cdnjs.cloudflare.com/ajax/libs/sweetalert2/11.14.0/sweetalert2.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'cdnjs.cloudflare.com/ajax/libs/sweetalert2/11.14.0/sweetalert2.min.css
',
                ]
            ],
        ],
