...
@section('body')
    <div class="{{ $auth_type ?? 'login' }}-box">
        ...
        <center>
            <img src="{{ asset('/images/intro.jpg') }}" alt="" width="70%">
        </center>
        <br>
        ...
        {{--         <div class="{{ $auth_type ?? 'login' }}-logo">
            <a href="{{ $dashboard_url }}">
                ...
                @else
                    <img src="{{ asset('/images/intro.jpg') }}" alt="{{ config('adminlte.logo_img_alt') }}" height="50">
                @endif
        ...
        <div class="card {{ config('adminlte.classes_auth_card', 'card-outline card-primary') }}"
            style="box-shadow: 5px 5px 5px #cccccc">
